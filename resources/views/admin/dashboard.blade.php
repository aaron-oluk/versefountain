...
<div class="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <button class="flex items-center px-3 sm:px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">
                    <i class="bx bx-calendar mr-2"></i>
                    Last 30 Days
                </button>
                <button class="flex items-center px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-xs sm:text-sm font-medium">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $activeCreators }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $newSubmissions }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $activeChatrooms->count() }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 sm:mb-8">
        <!-- Growth Chart -->
        <div class="lg:col-span-2 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6">
            <div class="mb-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-2.5 py-1 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 text-xs font-semibold rounded-full">LIVE</span>
            </div>
            <div class="space-y-3">
                ...
                <div class="pb-3 border-b border-gray-100 dark:border-gray-800 last:border-0 last:pb-0">
                    <div class="flex items-start justify-between mb-1">
                        <div class="flex items-center gap-2 min-w-0">
                            ...
                            <h3 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white truncate">{{ $room->name }}</h3>
                        </div>
                        <span class="w-2 h-2 bg-green-500 rounded-full flex-shrink-0 mt-1"></span>
                    </div>
                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ $room->members_count ?? $room->members->count() }} members</p>
                </div>
                @empty
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-6">
            ...
            <select class="text-xs sm:text-sm border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        <th class="text-left py-2 sm:py-3 px-3 sm:px-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Title</th>
                        <th class="text-left py-2 sm:py-3 px-3 sm:px-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Author</th>
                        <th class="text-left py-2 sm:py-3 px-3 sm:px-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Type</th>
                        <th class="text-left py-2 sm:py-3 px-3 sm:px-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Reads</th>
                        <th class="text-left py-2 sm:py-3 px-3 sm:px-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Status</th>
                        <th class="text-left py-2 sm:py-3 px-3 sm:px-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">Action</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($mostReadContent->take(8) as $book)
                    <tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        <td class="py-3 px-3 sm:px-4">
                            <p class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white truncate">{{ $book->title }}</p>
                        </td>
                        <td class="py-3 px-3 sm:px-4">
                            <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">{{ $book->author }}</p>
                        </td>
                        <td class="py-3 px-3 sm:px-4">
                            <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 text-xs font-medium rounded">Book</span>
                        </td>
                        <td class="py-3 px-3 sm:px-4">
                            <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">{{ number_format(rand(100, 5000)) }}</p>
                        </td>
                        <td class="py-3 px-3 sm:px-4">
                            <span class="px-2 py-1 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 text-xs font-medium rounded">Approved</span>
                        </td>
                        <td class="py-3 px-3 sm:px-4">
