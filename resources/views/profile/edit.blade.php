...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-md shadow-sm">
            ...
            <!-- Tab Navigation -->
            <div class="p-2">
                <nav class="flex flex-wrap sm:flex-nowrap gap-2 px-4 sm:px-6" aria-label="Tabs">
                    <button id="profile-tab" class="tab-button active px-4 py-2 rounded-lg font-medium text-sm text-white bg-blue-600 dark:bg-blue-500 flex-1 sm:flex-none transition-all">
                        Profile Information
                    </button>
                    <button id="password-tab" class="tab-button px-4 py-2 rounded-lg font-medium text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 flex-1 sm:flex-none transition-all">
                        Change Password
                    </button>
                    <button id="account-tab" class="tab-button px-4 py-2 rounded-lg font-medium text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 flex-1 sm:flex-none transition-all">
                        Account Settings
                    </button>
                </nav>
            </div>
