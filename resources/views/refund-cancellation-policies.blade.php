        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-4">
                    <a href="/" class="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm font-normal mr-4">
                        <i class="bx bx-arrow-back text-base mr-1"></i>
                        Back to Home
                    </a>
                </div>
                <h1 class="text-3xl sm:text-4xl font-semibold text-gray-900 dark:text-white mb-2">Refund and Cancellation Policies</h1>
                <p class="text-base text-gray-600 dark:text-gray-400 leading-relaxed">Please review our policies regarding refunds and cancellations for event tickets and subscriptions.</p>
                <p class="text-sm text-gray-500 dark:text-gray-500 mt-2">Last updated: {{ now()->format('F j, Y') }}</p>
            </div>

            <!-- Refund Policy Section -->
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:shadow-md border border-gray-200 dark:border-gray-800 p-6 sm:p-8 mb-6">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-4">
                        <i class="bx bx-money text-2xl text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Refund Policy</h2>
                </div>

                <div class="space-y-6">
                    <!-- Eligibility -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Eligibility for Refunds</h3>
                    ...
                    <!-- Timeframes -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Refund Timeframes</h3>
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-3 border border-gray-200 dark:border-gray-700">
                            <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                                <li class="flex items-start">
                                    <i class="bx bx-check-circle text-blue-600 dark:text-blue-400 mr-2 mt-0.5"></i>
                                ...
                                <li class="flex items-start">
                                    <i class="bx bx-x-circle text-gray-400 dark:text-gray-600 mr-2 mt-0.5"></i>
                    ...
                    <!-- Refund Process -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">How to Request a Refund</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Non-Refundable Items</h3>
                    ...
                    <!-- Processing Times -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Refund Processing Times</h3>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:shadow-md border border-gray-200 dark:border-gray-800 p-6 sm:p-8 mb-6">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-4">
                        <i class="bx bx-x-circle text-2xl text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Cancellation Policy</h2>
                </div>

                <div class="space-y-6">
                    <!-- Subscription Cancellation -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Subscription Cancellation</h3>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 dark:border-blue-400 p-4 mb-3">
                    ...
                    <!-- How to Cancel -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">How to Cancel Your Subscription</h3>
                        <ol class="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-300 ml-4">
                            <li>Log in to your VerseFountain account</li>
                    ...
                    <!-- Refund Eligibility -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Refund Eligibility for Subscriptions</h3>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                    ...
                    <!-- Prorated Refunds -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Prorated Refunds</h3>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Cancellation Effective Dates</h3>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
                    ...
                    <!-- Reactivation -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Reactivation Options</h3>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:shadow-md border border-gray-200 dark:border-gray-800 p-6 sm:p-8 mb-6">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Contact Us</h2>
                </div>

                <div class="space-y-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Need Help with Refunds or Cancellations?</h3>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                        <h4 class="font-semibold text-gray-900 dark:text-white mb-3 text-sm">Required Information for Requests</h4>
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
                    ...
                    <div>
                        <h4 class="font-semibold text-gray-900 dark:text-white mb-2 text-sm">Support Channels</h4>
                        <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <li class="flex items-center">
                                <i class="bx bx-envelope text-blue-600 dark:text-blue-400 mr-2"></i>
                                <span>Email: support@versefountain.com</span>
                            </li>
                            <li class="flex items-center">
                                <i class="bx bx-time text-blue-600 dark:text-blue-400 mr-2"></i>
                                <span>Response time: Within 24-48 hours</span>
                            </li>
                            <li class="flex items-center">
                                <i class="bx bx-calendar text-blue-600 dark:text-blue-400 mr-2"></i>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:shadow-md border border-gray-200 dark:border-gray-800 p-6 sm:p-8">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-4">
                        <i class="bx bx-shield text-2xl text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Dispute Resolution</h2>
                </div>
            ...
            <div class="mt-8 text-center">
                <a href="/" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium">
